...
<body class="hold-transition skin-blue sidebar-mini">
    <?php include '../../bss/checkLogin.php' ?>
                ...
                <section class="sidebar">
                    ...
                    <li class="treeview active">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li class="active"><a href="installCorp.php"><i class="fa fa-circle-o"></i>安装单位信息</a></li>
                            ...
                            <div class="box">
                                <div class="box-body">
                                    <table id="table1" class="table table-bordered table-hover">
                                        ...
                                        mysql_select_db("bishe");
                                        mysql_query("set names 'utf8'");
                                        $result = mysql_query("select * from installcorp");
            ...
            <div class="modal fade bs-example-modal modal-add" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <form action="../../bss/installCorp_bs.php" method="post">
        ...
        <script src="../../myjs/installCorp.js"></script>
