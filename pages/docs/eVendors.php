...
<body class="hold-transition skin-blue sidebar-mini">
                ...
                <ul class="sidebar-menu">
                    <li class="treeview active">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li class="active"><a href="eVendors.php"><i class="fa fa-circle-o"></i>生产厂家信息</a></li>
                            ...
                            <div class="box-body">
                                <table id="table1" class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        mysql_select_db("bishe");
                                        mysql_query("set names 'utf8'");
                                        $result = mysql_query("select * from evendors");
        ...
        <div class="modal fade bs-example-modal modal-add" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form action="../../bss/eVendors_bs.php" method="post">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title">电梯厂家添加</h4>
                        </div>
    ...
    <script src="../../myjs/eVendors.js"></script>
