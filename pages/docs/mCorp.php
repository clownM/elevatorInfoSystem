...
<body class="hold-transition skin-blue sidebar-mini">
                ...
                <ul class="sidebar-menu">
                    <li class="treeview active">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li class="active"><a href="mCorp.php"><i class="fa fa-circle-o"></i>维保单位信息</a></li>
                            ...
                            <div class="box-body">
                                <table id="table1" class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        mysql_select_db("bishe");
                                        mysql_query("set names 'utf8'");
                                        $result = mysql_query("select * from mcorp");
        ...
        <div class="modal fade bs-example-modal modal-add" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form action="../../bss/mcorp_bs.php" method="post">
    ...
    <script src="../../myjs/mcorp.js"></script>
