...
<body class="hold-transition skin-blue sidebar-mini">
    <?php include '../../bss/checkLogin.php' ?>
                ...
                <section class="sidebar">
                    ...
                    <li class="treeview active">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li class="active"><a href="mStaff.php"><i class="fa fa-circle-o"></i>维保人员信息</a></li>
                                ...
                                <div class="box-body">
                                    <table id="table1" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            mysql_select_db("bishe");
                                            mysql_query("set names 'utf8'");
                                            $result = mysql_query("select * from mstaff");
                                            ...
                                            <tr>
                                                ...
                                                <?php 
                                                $mcorpid = $row["mcorpid"];
                                                $myresult = mysql_query("select id,name from mcorp where id = '$mcorpid'");
            ...
            <div class="modal fade bs-example-modal modal-add" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <form action="../../bss/mStaff_bs.php" method="post">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span></button>
                                <h4 class="modal-title">维保人员</h4>
                            </div>
                                ...
                                <table class="mytable">
                                    <tbody>
                                        ...
                                        <tr class="row">
                                            ...
                                            <td class="col-xs-8">
                                                <select name="mcorpid" class="mcorpid myselect">
                                                <?php 
                                                $sql1 = mysql_query("select id, name from mcorp");
                                ...
                                <table class="mytable">
                                    <tbody>
                                        ...
                                        <tr class="row">
                                            <th class="col-xs-4">所属公司</th>
                                            <td class="col-xs-8">
                                                <select name="mcorpid" class="mcorpid myselect" id="mcorpid">
                                                <?php 
                                                $sql1 = mysql_query("select id, name from mcorp");
                                                while($row1 = mysql_fetch_array($sql1)){ ?>
                                                    <option value="<?php echo $row1["id"] ?>"><?php echo $row1["name"] ?></option>
        ...
        <script src="../../myjs/mStaff.js"></script>
