...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="wrapper">
                ...
                <ul class="sidebar-menu">
                    <li class="treeview active">
                        ...
                        <ul class="treeview-menu">
                            <li class="active"><a href="eUsers.php"><i class="fa fa-circle-o"></i>电梯使用单位</a></li>
        ...
        <div class="content-wrapper">
            ...
            <section class="insertItem">
                <button class="btn btn-primary pull-right" data-toggle="modal" data-target=".modal-add">添加档案</button>
            </section>
                            ...
                            <div class="box-body">
                                <table id="table1" class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        mysql_select_db("bishe");
                                        mysql_query("set names 'utf8'");
                                        $result = mysql_query("select * from eusers");
        ...
        <div class="modal fade bs-example-modal modal-add" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form action="../../bss/eUsers_bs.php" method="post" >
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title">电梯用户添加</h4>
                        </div>
                ...
                <div class="modal-content">
                    <form action="../../bss/eUsers_bs.php" method="post" >
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title">电梯用户资料</h4>
                        </div>
                        <div class="modal-body">
                            <table class="mytable">
                                <tbody>
    ...
    <script src="../../myjs/eUsers.js"></script>
